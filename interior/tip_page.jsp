...
%>
        <p>
                   조회수 
          <span class="font_green"><%= dto.getTip_count() %></span> 
          · 스크랩
          <span class="font_green"><%= dto.getTip_bookmark() %></span>
        </p>
        <p><%= dto.getTip_title() %></p>
        <p><input type="button" /></p>
        <p><%= dto.getTip_user_nick() %></p>
      </div>
