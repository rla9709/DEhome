...
<body>
	...
	<div id="introduce">
		...
		<div id="sub_title">
			...
			<img src="../images/room_05.jpg" alt="room" >
		</div><br><br>
			...
			<table>
				<tr>
					<td class="table_content">
						<img src="../images/tile.jpg" alt="tile" ><br>
		...
		<div id="sub_title">
			...
			<img src="../images/room_01.jpg" alt="room" width ="1000px">
		
		<div id="title">
			<h1>찾아오시는길</h1>
			<iframe  id = map 
				src="https://map.naver.com/v5/search/%EA%B7%B8%EB%A6%B0%EC%BB%B4%ED%93%A8%ED%84%B0%EC%95%84%EC%B9%B4%EB%8D%B0%EB%AF%B8/place/11578164?c=14366934.9928180,4184824.6516653,17,0,0,0,dh&placePath=%3Fentry%253Dbmp"/>
		</div>
