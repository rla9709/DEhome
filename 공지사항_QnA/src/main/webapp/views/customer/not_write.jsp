...
<body>
    ...
    <!-- --------------------- 컨텐츠 시작 ---------------------- -->
      ...
      <content>
        <div id="write">
            <form action="not_insert" method="post" name="form">
              <p><span>Notice</span> 공지사항쓰기</p>
              <table>
                <tr>
                  <td>
                    <input class="board_title" name="not_title" type="text" placeholder="제목을 작성해주세요" />
                  </td>
                  <tr>
	                <td>
...
<!--                     <input type="submit" value="작성하기"> -->
                    <input type="button" value="작성하기" onclick="not_write_ok()">
