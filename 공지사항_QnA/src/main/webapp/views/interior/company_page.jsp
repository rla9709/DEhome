...
<body>
    ...
    <input type="hidden" value="${comInfo.re_count }" id="com_re_count">
    <input type="hidden" value="${comInfo.com_contract }" id="com_contract">
	<div id="move_btn2">
    ...
    <div id="company_work">
	    	<c:forEach items="${exList }" var="exList">
				<a href="../interior/cons_case.jsp?ex_no=${exList.ex_no }">
				  <div>
				    <img src="${path}/resources/images/room_01.jpg" /> <!-- 사진경로 넣어야한다 -->
				  </div>
				  <p>${exList.ex_title }</p>
				</a>
			</c:forEach>
