...
<%
	...
	InteriorDAO interior = InteriorDAO.getinstance();
	...
	if (request.getParameter("popup_addr1") != null || request.getParameter("popup_addr2") != null) {
		...
		if (userAddr != null) {
			...
			System.out.println("유저 주소 받음");
		} else {
			System.out.println("유저 주소 받아오지 못함");
		}
	}
      ...
      <table>
	      ...
	      <%
	      	for (int i = 1; i <= comList.size(); i++) {
	      		...
	      		com_rating = board.getIn_com_rating();
