...
<%
	...
	String user_nick="",user_id="",user_pw="",user_name="", user_email="",user_email2="",user_addr1="",user_addr2="",user_addr3="",user_addr4="";
	int user_pnum=0;
	...
	if(dto != null){
		...
		user_pw = dto.getUser_pw();//기존 비밀번호
		user_name = dto.getUser_name();
		user_email = dto.getUser_email();
		user_email2 = dto.getUser_email2();
		user_addr1 = dto.getUser_addr1();
		user_addr2 = dto.getUser_addr2();
 ...
 <!-- ---------- 개인정보 수정 -------------->
        ...
        <div class="contents_box_edit">
        	<form method="post" name="form" action="edit_account_ok.jsp?real_pw=<%=user_pw%>">
            ...
            <div class="edit_account_box">
              ...
              <p class="mypage_content_list_list">
                <input type="text" name="user_name" placeholder="회원이름" value="<%=user_name%>"  disabled="disabled"/>
              </p>
            </div>
            <div class="edit_account_box">
              <p class="mypage_content_edit_list">아이디</p>
              <p class="mypage_content_list_list">
                <input type="text" name="user_id" placeholder="회원ID" value="<%=user_id%>" disabled="disabled" />
              </p>
            </div>
            <div class="edit_account_box">
            ...
            <div class="edit_account_box">
              ...
              <p class="mypage_content_list_list">
                <input type="tel" name="user_pnum" size="11" value="0<%=user_pnum%>"/>
              </p>
            </div>
              <div class="edit_account_box">
              ...
              <p class="mypage_content_list_list">
                <input type="text" name="user_email" value="<%=user_email%>"/>
                 @
	             <input type="text" name="user_email2" value="<%=user_email2%>" disabled="disabled" style="height: 25px; margin-top: 5px"/>
            ...
            <div class="edit_account_box" style="height: 180px">
              ...
              <div class="mypage_content_list_list">
                <div>
                  <input type="text" name="user_addr1" id="postcode" value="<%=user_addr1%>"/>
                  <input
                    type="button"
                    value="우편번호 검색"
