...
<c:set var="naverNickname" value="${naverNickname}"/>
<c:set var="naverEmail1" value="${naverEmail1}"/>
<c:set var="naverEmail2" value="${naverEmail2}"/>
<c:set var="naverGender" value="${naverGender}"/>
<c:set var="naverPNum" value="${naverPNum}"/>
<c:set var="naverName" value="${naverName}"/>

<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>회원정보 추가 등록</title>
...
<body>
	<jsp:include page="../headerfooter/header.jsp"/>
      ...
      <div class="contents_sign_up">
        ...
        <form method="post" name="register_form" action="../user/registerNaver.do">
        <input type="hidden" name="login_type" value=""/>
          <div class="sign_up_box">
            <h3 class="sign_up_box_title">네이버 로그인 추가정보 등록</h3>
            ...
            <p>
              <input type="text" name="user_name" class="sign_up_input" value="${naverName}"/>
            </p>
            <br />
            ...
            <p>
              <input type="text" name="user_email" class="sign_up_input2" value="${naverEmail1 }"/>
              @
              <input type="text" name="user_email2" class="sign_up_input2"  disabled="disabled" value="${naverEmail2}"/>
