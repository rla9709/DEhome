		...
		<div class="mainForm">
			...
			<div class="used_post_box" id="used_post_box">
				<c:forEach var="list" items="${list}">
					<div class="used_post" onclick="location.href='tradeShow'">
						<div class="post_image_div">
							<img class="post_image" src="${path}${list.tr_photo}" />
						</div>
