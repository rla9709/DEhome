...
<script type="text/javascript" src="${path }/resources/js/mypage.js" charset="utf-8"></script>
 ...
 <div class="contents_box_edit">
            ...
            <div class="edit_account_box">
              ...
              <p class="mypage_content_list_list">
                <input type="text" name="user_id" placeholder="회원ID" value="${userInfo.user_id}"   disabled="disabled" />
              </p>
            </div>
            <div class="edit_account_box">
              <p class="mypage_content_edit_list">닉네임</p>
              <p class="mypage_content_list_list">
                <input type="text" name="user_nick" placeholder="회원 닉네임" value="${userInfo.user_nick}" />
              </p>
            </div>
            <div class="edit_account_box">
            ...
            <div class="edit_account_box">
              ...
              <p class="mypage_content_list_list">
                <input type="text" name="user_email" value="${userInfo.user_email}"/>
                 @
 ...
 <%--       
        <div class="contents_box_edit">
        	<form method="post" name="form" action="edit_account_ok.jsp?real_pw=${userInfo.}${userInfo.}<%=user_pw%>">
            <div class="edit_account_box">
              <p class="mypage_edit_label">개인정보 수정</p>
            </div>
            <div class="edit_account_box">
              <p class="mypage_content_edit_list">이름</p>
              <p class="mypage_content_list_list">
                <input type="text" name="user_name" placeholder="회원이름" value="${userInfo.}${userInfo.}<%=user_name%>"  disabled="disabled"/>
              </p>
            </div>
            <div class="edit_account_box">
              <p class="mypage_content_edit_list">아이디</p>
            ...
            <div class="edit_account_box" style="height: 180px">
              ...
              <div class="mypage_content_list_list">
                <div>
                  <input type="text" name="user_addr1" id="postcode" value="${userInfo.}<%=user_addr1%>"/>
                  <input
                    type="button"
                    value="우편번호 검색"
                    name="address_search_button"
