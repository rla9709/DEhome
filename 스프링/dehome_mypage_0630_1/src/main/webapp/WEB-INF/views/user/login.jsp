          ...
          <div class="login_box">
			...
			<script type="text/javascript">
				function loginWithKakao() {
					location.href="https://kauth.kakao.com/oauth/authorize?client_id=a432da059b4de91d00d92037e8bb2578&redirect_uri=http://localhost:8181/dehome/main/kakaoMainpage&response_type=code";
				}
			</script>
