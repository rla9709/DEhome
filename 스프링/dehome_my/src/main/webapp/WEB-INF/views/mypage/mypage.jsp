...
<!-------  최근 거래  -------->
        <div class="mypage_content_box">
          ...
          <div class="mypage_content_list_main" 
          	   onclick="location.href='../trade/tradeShow?tr_no=${tr_list.trade_no}&ch=0&heart=none'">
          		<div>
			 	<img class="my_sell_image" src="${path}${tr_list.trade_photo}"/>
          		</div>
        ...
        <div class="mypage_content_box">
          ...
          <div class="mypage_content_list_main" 
          	   onclick="location.href='../trade/tradeShow?tr_no=${tr_sell_list.trade_no}&ch=0&heart=none'">
          		<div>
			<img class="my_sell_image" src="${path}${tr_sell_list.trade_photo}"/>
          		</div>
				<div class="my_sell_text">
