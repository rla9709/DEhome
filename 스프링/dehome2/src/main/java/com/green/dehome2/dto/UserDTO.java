...
public class UserDTO {
	...
	public String toString() {
		return "UserDTO [user_nick=" + user_nick + ", user_id=" + user_id + ", user_pw=" + user_pw + ", user_name="
				+ user_name + ", user_email=" + user_email + ", user_email2=" + user_email2 + ", user_addr1="
				+ user_addr1 + ", user_addr2=" + user_addr2 + ", user_addr3=" + user_addr3 + ", user_addr4="
				+ user_addr4 + ", user_sex=" + user_sex + ", user_pnum=" + user_pnum + ", email=" + email + "]";
	}
