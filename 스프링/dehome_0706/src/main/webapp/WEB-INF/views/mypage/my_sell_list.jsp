        ...
        <div class="mypage_header_box">
          ...
          <div class="mypage_sidebar_box">
            ...
            <ul class="mypage_ul2">
              ...
              <li class="mypage_side_list" style="color: #1B7850"><a href="../mypage/my_sell_list">내가 등록한 물품 ></a></li>
              <li class="mypage_side_list"><a href="my_trade_list">나의 구매 물품</a></li>
          ...
          <div class="mypage_content_box">
	          ...
	          <c:forEach var="mySellList" items="${mySellList}">
	         	 <div class="mypage_content_list_main" 
	          		   onclick="location.href='../trade/tradeShow?tr_no=${mySellList.tr_no}'">
	          		<div>
						<img class="my_sell_image" src="${mySellList.tr_photo}"/>
	          		</div>
