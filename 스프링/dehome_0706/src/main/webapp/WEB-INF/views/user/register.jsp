...
<body>
	<jsp:include page="../headerfooter/header.jsp"/>
      ...
      <div class="contents_sign_up">
        ...
        <form method="post" name="register_form" action="register">
          <div class="sign_up_box">
            <h3 class="sign_up_box_title">사이트 내 정보입력 회원가입</h3>
            
            <p class="sign_up_label">닉네임</p>
            <p>
	            <input type="text" name="user_nick_fake" id="user_nick_fake" class="sign_up_input3" placeholder="닉네임은 특수문자 사용이 불가능합니다" />
	            <input type="hidden" name="user_nick" id="user_nick" />
			...
			<div class="mail_check_wrap">
				...
				<div class="mail_check_btn_box">
					<input type="button" id="mail_valid" class="mail_check_btn" value="인증번호 전송" >
				</div>
			</div>
