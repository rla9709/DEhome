...
public class InteriorController {
	...
	public String getMoreInteriorList(HttpSession session, InteriorDTO dto, String paddr1, String paddr2, String more) throws Exception {
		...
		for (InteriorDTO board : morelocList) {
			...
			jboard.put("com_file", board.getCom_file());
	...
	public String getMoreReList(InteriorDTO dto, String more, String com_name, String type) throws Exception {
		...
		/*--해당 업체 정보가져오기--*/
		String re_com_name = com_name; //list에서 던진 업체명
		...
		if(type.equals("re")) { // 시공 리뷰 더보기일때
			...
			for (InteriorDTO board : moreReList) {
				...
				jboard.put("re_thumbfile", board.getRe_thumbfile());
			...
			for (InteriorDTO board : moreExList) {
				...
				jboard.put("ex_thumbfile", board.getEx_thumbfile());
	...
	public String registerCom(MultipartFile file, Model model, InteriorDTO dto, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		dto.setCom_file(File.separator + "imgUpload" + ymdPath + File.separator + fileName);
		dto.setCom_thumbfile(File.separator + "imgUpload" + ymdPath + File.separator + "s" + File.separator + "s_" + fileName);
	...
	public String reviewRegist(MultipartFile file, InteriorDTO dto, HttpServletRequest request, HttpSession session) throws Exception {
		...
		dto.setRe_file(File.separator + "imgUpload" + ymdPath + File.separator + fileName);
		dto.setRe_thumbfile(File.separator + "imgUpload" + ymdPath + File.separator + "s" + File.separator + "s_" + fileName);
	...
	public ModelAndView reviewShow(HttpSession session, HttpServletRequest request, InteriorDTO dto) throws Exception {
		...
		System.out.println(review.getRe_title());
...
//		mav.addObject("like", like);
	...
	public String reviewLike(HttpSession session, int re_no, String type, InteriorDTO dto) throws Exception {
