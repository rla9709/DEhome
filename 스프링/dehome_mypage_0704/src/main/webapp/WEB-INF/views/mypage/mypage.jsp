...
<!-------  최근 거래  -------->
        <div class="mypage_content_box">
          ...
          <div class="mypage_content_list_main" 
          	   onclick="location.href='../trade/tradeShow?tr_no=${tr_list.trade_no}'">
          		<div>
			 	<img class="my_sell_image" src="${tr_list.trade_photo}"/>
          		</div>
...
<!--     판매 내역     -->
        ...
        <div class="mypage_content_box">
          ...
          <div class="mypage_content_list_main" 
          	   onclick="location.href='../trade/tradeShow?tr_no=${tr_sell_list.trade_no}'">
          		<div>
			<img class="my_sell_image" src="${tr_sell_list.trade_photo}"/>
          		</div>
				<div class="my_sell_text">
				...
				<c:if test="${fn:length(tr_sell_list) >4}">
					<div>
						<button class="moreTrade" onclick="">
							더<br>보<br>기</button>
					</div>
				</c:if>
			</div>
<!--   구매 내역  --> 
        <div class="mypage_content_box">
          ...
          <div class="mypage_content_list_main" 
          	   onclick="location.href='../trade/tradeShow?tr_no=${tr_buy_list.trade_no}'">
          		<div>
					<img class="my_sell_image" src="${tr_buy_list.trade_photo}"/> 
          		</div>
				<div class="my_sell_text">
