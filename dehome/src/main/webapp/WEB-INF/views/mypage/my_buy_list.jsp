 	...
 	<div class="contents_mypage">
        ...
        <div class="mypage_header_box">
            ...
            <ul class="mypage_ul2">
              ...
              <li class="mypage_side_list" style="color: #1B7850"><a href="#">나의 거래 ></a>
                 <ul class="mypage_side_list_2">
                    ...
                    <li style="color: #1B7850"><a href="../mypage/my_buy_list">나의 구매 물품 ></a></li>
                 </ul>
              </li>
          ...
          <div class="mypage_content_box">
	          <p class="mypage_label">내가 등록한 물품</p>
	          <c:forEach var="myBuyList" items="${myBuyList}">
	         	 <div class="mypage_content_list_main" 
	          		   onclick="location.href='../trade/tradeShow?tr_no=${myBuyList.tr_no}'">
	          		<div>
						<img class="my_sell_image" src="${myBuyList.tr_photo}"/>
	          		</div>
					<div class="my_sell_text">
						<p class="my_sell_title">${myBuyList.tr_title}</p>
						<p class="my_sell_addr">${myBuyList.user_addr2}</p>
						<c:choose>
	                         <c:when test="${myBuyList.like != 0}">
	                         <div class="my_ut_price_heart">
		                       <c:choose>
		                         <c:when test="${myBuyList.tr_price eq '0' }">
										<p class="my_sell_price">무료나눔</p>	
								 </c:when>	
								 <c:otherwise>					
										<p class="my_sell_price">${myBuyList.tr_price} 원</p>		
								 </c:otherwise>		
								</c:choose> 				
								<div class="my_ut_heart_img_div">
									<img src="${path }/resources/images/heart.png" class="my_ut_heart" /> 
									<span class="my_ut_heart_cnt">${myBuyList.like}</span>
								</div>
							</div>
								<c:choose>
									<c:when test="${myBuyList.tr_complete == 1 }">
